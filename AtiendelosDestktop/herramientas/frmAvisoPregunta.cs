using AtiendelosDestktop.herramientas.forms;
using System;
...
namespace AtiendelosDestktop.herramientas
{
    ...
    public partial class frmAvisoPregunta : Form
    {
        ...
        public frmAvisoPregunta(Form ventana, string mensaje, string titulo = "", string tipo = "", Form ventanaModal = null, bool left_button = false)
        {
            ...
            this.Location = globales.menuPrincipal.Location;
        ...
        private void frmAvisoPregunta_Load_1(object sender, EventArgs e)
        {
            if (tipo == "modal")
            {
